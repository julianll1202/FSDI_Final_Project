...
function UserInfo(props) {
   const [userInfo, setUserInfo] = useState({});
    ...
    const editUserInfo = async e => {
        ...
        let res = await service.editUserInfo( userInfo);
        console.log(res);
    }
            ...
            <form onSubmit={editUserInfo}>
                <div className="user-name">
                    <div className="first-name">
                        ...
                        <input name="name" enabletype="text" className="form-control" onChange={handleUserChange} placeholder={userInfo['name']} disabled/>
                    </div>    
                    <div className="first-name">
                        <label className="form-label">Last Name</label>
                        <input name="last_name" type="text" className="form-control" onChange={handleUserChange} placeholder={userInfo['last_name']} disabled/>
                    </div>   
                </div>
